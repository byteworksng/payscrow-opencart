...
<table class="table table-striped table-bordered">
  <tr>
    ...
    <td><?php echo $payscrow_order['order_ref']; ?></td>
  </tr>
  <tr>
    <td><?php echo $text_order_total; ?></td>
    <td><?php echo $payscrow_order['total_formatted']; ?></td>
  </tr>
  <tr>
    <td><?php echo $text_total_captured; ?></td>
    <td id="payscrow_total_captured"><?php echo $payscrow_order['total_captured_formatted']; ?></td>
  </tr>
  <tr>
    <td><?php echo $text_capture_status; ?></td>
    <td id="capture_status"><?php if ($payscrow_order['capture_status'] == 1) { ?>
      <span class="capture_text"><?php echo $text_yes; ?></span>
      <?php } else { ?>
      <span class="capture_text"><?php echo $text_no; ?></span>&nbsp;&nbsp;
      <?php if ($payscrow_order['void_status'] == 0) { ?>
  ...
  <tr>
    ...
    <td id="void_status"><?php if ($payscrow_order['void_status'] == 1) { ?>
  ...
  <tr>
    ...
    <td><table class="table table-striped table-bordered" id="payscrow_transactions">
        <thead>
          <tr>
        ...
        <tbody>
          <?php foreach($payscrow_order['transactions'] as $transaction) { ?>
          <tr>
...
<form method="POST" id="voidform" action="<?php echo $action_url; ?>">
  ...
  <input type="hidden" name="oid" value="<?php echo $payscrow_order['order_ref']; ?>"/>
  <input type="hidden" name="tdate" value="<?php echo $payscrow_order['tdate']; ?>"/>
